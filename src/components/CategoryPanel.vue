...
<template>
	<div v-if="getLoadingState" class="flex w-full items-center justify-center gap-4 py-4">
	...
	<template v-else>
		<v-expansion-panels>
			<v-expansion-panel v-for="category in getCategoriesByNotebook" :key="category.id">
